...
public class CustomBottomSheetBehaviorJava<V extends View> extends CoordinatorLayout.Behavior<V> {
...
// Make sure the java file name & this class name, matches.
    ...
    @CustomBottomSheetBehaviorJava.State
     ...
     */
    public CustomBottomSheetBehaviorJava() {
    }
     ...
     */
    public CustomBottomSheetBehaviorJava(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public void addBottomSheetCallback(CustomBottomSheetBehaviorJava.BottomSheetCallback callback) {
        mCallbacks.add(callback);
    }

    public void removeBottomSheetCallback(CustomBottomSheetBehaviorJava.BottomSheetCallback callback) {
     ...
     */
    public final void setState(final @CustomBottomSheetBehaviorJava.State int state) {
        if (state == mState) {
            return;
        }
        if (mViewRef == null) {
    ...
    void setStateInternal(@CustomBottomSheetBehaviorJava.State int state) {
        if (mState == state) {
            return;
        }
        int oldState = mState;
    ...
    private void calculateTopAndTargetState(View child, float xvel, float yvel, int[] out) {
        int top;
        @CustomBottomSheetBehaviorJava.State int targetState;
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            int top = out[0];
            @CustomBottomSheetBehaviorJava.State int targetState = out[1];
...
//                    mMediaPlayerBarHeight = 64
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable(View view, @CustomBottomSheetBehaviorJava.State int targetState) {
            mView = view;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @CustomBottomSheetBehaviorJava.State int state) {
            super(superState);
            this.state = state;
        }
    ...
    /**
     * A utility function to get the {@link CustomBottomSheetBehaviorJava} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link CustomBottomSheetBehaviorJava}.
     * @return The {@link CustomBottomSheetBehaviorJava} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> CustomBottomSheetBehaviorJava<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof CustomBottomSheetBehaviorJava)) {
            throw new IllegalArgumentException(
                    "The view is not associated with AnchorBottomSheetBehavior");
        }
        return (CustomBottomSheetBehaviorJava<V>) behavior;
    }
}
